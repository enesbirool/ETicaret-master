...
namespace ETicaret
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //        options.UseSqlServer(Configuration.GetConnectionString("ETicaretContextUzakSqlServer")));

            services.AddDbContext<ETicaretContext>(options =>
                    options.UseSqlite(Configuration.GetConnectionString("ETicaretContextSqlite")));

            //services.AddDbContext<ETicaretContext>(options =>
            //        options.UseMySql(Configuration.GetConnectionString("ETicaretContextUzakMySqlServer"),
